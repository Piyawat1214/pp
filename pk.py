...
os.system("clear")
print("________________________________script By:ปิยะวัฒน์ ทวีคำ______________________")
print("__________________________________100api___________________________________")
print("")
print("_______________________________ปิยะวัฒน์ ทวีคำ______________________")
print("")
print("________________________________Python100%________________________")
print("")
print("_______________________________github: Piyawat1214:_______________________")
print("nothuman")
print("")
